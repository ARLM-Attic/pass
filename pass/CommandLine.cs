...
onde os modificadores e valores válidos são:", mensagemErro);
        ...
        [CommandParameter("-f", NULL_STR)]
        protected string ARGFileName { get; set; }

        public string GetFileName()
        {
            if (ARGFileName != NULL_STR)
                return Path.GetFullPath(ARGFileName);
    ...
    /// <summary>
    /// Enumeracao que descreve o formato de visualizacao dos resultados
    /// </summary>
